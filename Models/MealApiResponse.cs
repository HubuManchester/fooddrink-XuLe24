...
public class MealApiResponse { [JsonPropertyName("meals")] public List<MealDto>? Meals { get; set; } }
public class MealDto
{
    [JsonPropertyName("idMeal")]        public string IdMeal        { get; set; } = string.Empty;
    [JsonPropertyName("strMeal")]       public string StrMeal       { get; set; } = string.Empty;
    [JsonPropertyName("strCategory")]   public string StrCategory   { get; set; } = string.Empty;
    [JsonPropertyName("strArea")]       public string StrArea       { get; set; } = string.Empty;
    [JsonPropertyName("strInstructions")] public string StrInstructions { get; set; } = string.Empty;
    [JsonPropertyName("strMealThumb")]  public string StrMealThumb  { get; set; } = string.Empty;
